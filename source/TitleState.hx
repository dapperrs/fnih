...
class TitleState extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:					
					createCoolText(['Me and'], 15);
				case 2:
					addMoreText('Dappers', 15);
				// credTextShit.visible = false;
				...
				case 3:
					deleteCoolText();
				case 4:	
					createCoolText(['Built on'], -60);
				case 5:
					addMoreText('Ye boy', -60);
				...
				// credTextShit.text += '\nNight';
				case 12:
					addMoreText('Hollywood'); // credTextShit.text += '\nFunkin';
