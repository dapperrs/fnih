...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Cheese', "jeff walking past lmao, only works for bruh week"],
		['dead', "killing the guards lol, this is unused tho"],
		['Bruh', "this is supposed to make bruh do well, bruh. this is cut tho might use it later"],
		['blackLayer', "for hostage haha. does bruh die? idk lol"],
		['Rise', "for guns song lmao"],
		['Shots', "ONLY WORKS IN HOSTAGE AND MEETING. this adds the shooting mechanic"]
	];
