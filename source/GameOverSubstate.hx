...
class GameOverSubstate extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float, camX:Float, camY:Float, state:PlayState)
	{
		...
		if (doIt)
			{
				var random = FlxG.random.int(0,5);
				switch(random)
				{
					case 0:
						daText = "Lol, couldn't keep up dude? Hello?";
					case 1:
						daText = "Funk yeah, Got ya there! Yo?";				
					case 3:
						daText = "Heh, hey buddy you good?";				
					case 4:
						daText = "Bruh, I got ya this time.";	
					case 5:
						daText = "Hey, let's get some medical attention here.";										
				}
				doIt = false;
			}	
			else
				doIt = false; // set to false cuz this is not ready to be done, next update?

		swagDialogue = new FlxTypeText(bf.x, bf.y + 500, Std.int(FlxG.width * 0.6), daText, 24);
